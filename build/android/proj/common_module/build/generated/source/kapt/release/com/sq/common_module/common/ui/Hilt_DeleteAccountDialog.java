...
public abstract class Hilt_DeleteAccountDialog<VDB extends ViewDataBinding> extends BaseDialogFragment<VDB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeleteAccountDialog_GeneratedInjector) this.generatedComponent()).injectDeleteAccountDialog(UnsafeCasts.<DeleteAccountDialog>unsafeCast(this));
    }
  }
