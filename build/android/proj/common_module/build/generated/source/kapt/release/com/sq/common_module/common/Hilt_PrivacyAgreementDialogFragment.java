...
public abstract class Hilt_PrivacyAgreementDialogFragment<VDB extends ViewDataBinding> extends BaseDialogFragment<VDB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrivacyAgreementDialogFragment_GeneratedInjector) this.generatedComponent()).injectPrivacyAgreementDialogFragment(UnsafeCasts.<PrivacyAgreementDialogFragment>unsafeCast(this));
    }
  }
