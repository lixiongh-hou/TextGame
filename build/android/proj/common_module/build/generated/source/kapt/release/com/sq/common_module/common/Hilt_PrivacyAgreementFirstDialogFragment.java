...
public abstract class Hilt_PrivacyAgreementFirstDialogFragment<VDB extends ViewDataBinding> extends BaseDialogFragment<VDB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrivacyAgreementFirstDialogFragment_GeneratedInjector) this.generatedComponent()).injectPrivacyAgreementFirstDialogFragment(UnsafeCasts.<PrivacyAgreementFirstDialogFragment>unsafeCast(this));
    }
  }
