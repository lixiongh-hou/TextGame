...
public abstract class Hilt_RealAuthDialogFragment<VDB extends ViewDataBinding> extends BaseDialogFragment<VDB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RealAuthDialogFragment_GeneratedInjector) this.generatedComponent()).injectRealAuthDialogFragment(UnsafeCasts.<RealAuthDialogFragment>unsafeCast(this));
    }
  }
