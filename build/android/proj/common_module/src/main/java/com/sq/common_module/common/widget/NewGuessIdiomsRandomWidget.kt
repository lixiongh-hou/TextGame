 ...
 * 猜成语 四种情况
 */
class NewGuessIdiomsRandomWidget @JvmOverloads constructor(
        ...
        when (mShowPosition) {
            1 -> {
                ...
                if (isCorrect) {
                    ...
                    mTvGuess1.setBackgroundResource(R.drawable.ic_guess_new_box_2)
                }
            }
            2 -> {
                mTvGuess6.text = s
                if (isCorrect) {
                    ...
                    mTvGuess6.setBackgroundResource(R.drawable.ic_guess_new_box_2)
                }
            }
            3 -> {
                mTvGuess11.text = s
                if (isCorrect) {
                    ...
                    mTvGuess11.setBackgroundResource(R.drawable.ic_guess_new_box_2)
                }
            }
            4 -> {
                mTvGuess16.text = s
                if (isCorrect) {
                    ...
                    mTvGuess16.setBackgroundResource(R.drawable.ic_guess_new_box_2)
                }
            }
        }
    }
    ...
    private fun setTextDrawable(textView: AppCompatTextView, isInit: Boolean) {
        textView.setBackGroundRes(isInit, R.drawable.ic_guess_new_box_1, R.drawable.ic_guess_new_box_3)
