 ...
 * 猜成语 四种情况
 */
class GuessIdiomsRandomWidgeThird @JvmOverloads constructor(
    ...
    init {
        val view =
            LayoutInflater.from(context).inflate(R.layout.layout_new_guess_idioms_widget_third, this)
        ...
        when (mShowPosition) {
            1 -> {
                ...
                if (isCorrect) {
                    ...
                    mTvGuess1.setBackgroundResource(R.drawable.ic_guess_box_2_100)
                }
            }
            2 -> {
                mTvGuess6.text = s
                if (isCorrect) {
                    ...
                    mTvGuess6.setBackgroundResource(R.drawable.ic_guess_box_2_100)
                }
            }
            3 -> {
                mTvGuess11.text = s
                if (isCorrect) {
                    ...
                    mTvGuess11.setBackgroundResource(R.drawable.ic_guess_box_2_100)
                }
            }
            4 -> {
                mTvGuess16.text = s
                if (isCorrect) {
                    ...
                    mTvGuess16.setBackgroundResource(R.drawable.ic_guess_box_2_100)
                }
            }
        }
    }
    ...
    private fun setTextDrawable(textView: AppCompatTextView, isInit: Boolean) {
        if (textView.text == ""){
            textView.setBackGroundRes(isInit, R.drawable.ic_guess_box_4_100, R.drawable.ic_guess_box_3_100)
        }else{
            textView.setBackGroundRes(isInit, R.drawable.ic_guess_box_1_100, R.drawable.ic_guess_box_3_100)
        }
